**Briseis** - многопроцессорный и многопоточный poller для сбора метрик с сетевых устройств по протоколу SNMPv2 и отправки их Graphite. Написан на Python и работат как Unix-демон.
