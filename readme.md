...
- Собирать значения длин кабелей "последней мили"[^cabdiag]
...
[^cabdiag]: Диагностика кабельной линии может иметь побочные последствия, такие как выключение порта на момент опроса или сбой в логике его работы. Для оборудования *D-Link* я рекомендую использовать диагностику только в корпоративных сетях (не в сетях провайдеров) и только на 100 Мбитных портах.
